        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8">
                <div class="prose max-w-none">
                    ...
                    <p class="text-lg leading-relaxed text-gray-700" data-en="From our state-of-the-art laboratories to our advanced manufacturing facilities, every aspect of our operation reflects our commitment to setting new standards in gold trading, testing, and craftsmanship. We pride ourselves on combining traditional expertise with cutting-edge technology to deliver unparalleled service to our clients worldwide." data-ar="من مختبراتنا المتطورة إلى مرافق التصنيع المتقدمة، كل جانب من عملياتنا يعكس التزامنا بوضع معايير جديدة في تجارة الذهب والاختبار والحرفية.">
                        From our state-of-the-art laboratories to our advanced manufacturing facilities, every aspect of our operation reflects our commitment to setting new standards in gold trading, testing, and craftsmanship. We pride ourselves on combining traditional expertise with cutting-edge technology to deliver unparalleled service to our clients worldwide.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-gold-500 mb-2">30+</div>
                        <div class="text-sm text-gray-500" data-en="Years Experience" data-ar="سنة خبرة">Years Experience</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-gold-500 mb-2">10K+</div>
                        <div class="text-sm text-gray-500" data-en="Satisfied Clients" data-ar="عميل راضي">Satisfied Clients</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-gold-500 mb-2">50+</div>
                        <div class="text-sm text-gray-500" data-en="Countries Served" data-ar="دولة مخدومة">Countries Served</div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                    <img src="assets/alrafe-gold-bar.png" alt="Gold Laboratory" class="w-full h-96 object-cover">
                    <div class="absolute inset-0 bg-gradient-to-t from-gold-100/70 to-transparent"></div>
                    <div class="absolute bottom-6 left-6 right-6">
                        <h3 class="text-xl font-semibold text-dark-900 mb-2" data-en="State-of-the-Art Facilities" data-ar="مرافق متطورة">State-of-the-Art Facilities</h3>
                        <p class="text-gray-700 text-sm" data-en="Our advanced laboratory and manufacturing facilities" data-ar="مختبرنا المتقدم ومرافق التصنيع">Our advanced laboratory and manufacturing facilities</p>
                    </div>
                </div>
                
                <!-- Floating Badge -->
                <div class="absolute -top-6 -right-6 bg-gold-500 text-dark-900 px-4 py-2 rounded-full shadow-lg">
                    <span class="font-semibold text-sm" data-en="ISO Certified" data-ar="معتمد ISO">ISO Certified</span>
                </div>
            </div>
        </div>
    </div>
